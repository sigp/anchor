...
If you want to migrate an existing key from the Golang implementation of SSV, you can directly proceed to Step 3 or check out the dedicated [switching to anchor](/switching_to_anchor) section.
