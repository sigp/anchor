...
wget https://github.com/sigp/anchor/releases/download/v1.0.0/anchor-v1.0.0-x86_64-unknown-linux-gnu.tar.gz
tar -xvf anchor-v1.0.0-x86_64-unknown-linux-gnu.tar.gz
