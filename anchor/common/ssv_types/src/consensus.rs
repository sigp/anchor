...
mod tests {
    ...
    fn blinded_execution_payload_envelope_root_parity() {
        ...
        // Generated by this implementation at consensus-specs pin a5a1bc630; it pins
        // regressions, and MUST be cross-checked against a second SSZ implementation
        // (go-ssv) when one exists.
