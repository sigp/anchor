...
use ssv_types::{
    ClusterId, MultiIndexClusterMap, MultiIndexShareMap, MultiIndexValidatorMetadataMap, Operator,
    OperatorId,
};
use tokio::sync::{
    watch,
...
struct MultiState {
    shares: MultiIndexShareMap,
    validator_metadata: MultiIndexValidatorMetadataMap,
