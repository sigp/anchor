...
**ALWAYS use the tester-subagent when creating tests.** The tester-subagent has comprehensive knowledge of Anchor's testing patterns, QBFT consensus testing, bug reproduction methodology, and all crate-specific requirements.
