...
- **Behavioral claims require evidence**: before asserting language/runtime behavior or performance implications, check authoritative docs/source or run a minimal repro; if not verified, label it as a hypothesis or ask.
